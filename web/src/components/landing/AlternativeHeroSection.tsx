...
export const AlternativeHeroSection = () => {
    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-brand-primary-light via-brand-primary-50 to-white pt-20">
      ...
      >
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              ...
              <h1 className="text-3xl font-bold text-neutral-900 sm:text-4xl md:text-5xl lg:text-6xl">
                Live Local Deals & Happy Hours
              </h1>
            </motion.div>

            {/* Line 2: Hidden Gems & Experiences */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            Stop scrolling endless review sites. Yohop shows you a live map of exclusive deals and happy hours from top-rated local spots, ready for you right now.
          </motion.p>
          ...
          <div className="border-neutral-border/20 h-full w-full rounded-md border bg-white/50 p-4 shadow-inner">
            ...
            >
              <defs>
                ...
                <filter id="shadow-alt" x="-50%" y="-50%" width="200%" height="200%">
              ...
              <path
                ...
                fill="url(#glow-alt)"
                filter="url(#shadow-alt)"
              />

              {/* Animated deal markers with different colors */}
              <circle cx="150" cy="200" r="8" fill="#F59E0B" opacity="0.8">
                <animate attributeName="cy" values="200;190;200" dur="3s" repeatCount="indefinite" />
                <animate attributeName="r" values="8;10;8" dur="2s" repeatCount="indefinite" />
              </circle>
              <circle cx="300" cy="180" r="6" fill="#EF4444" opacity="0.6">
              ...
              <circle cx="500" cy="220" r="7" fill="#10B981" opacity="0.7">
              ...
              <circle cx="650" cy="190" r="5" fill="#8B5CF6" opacity="0.5">
                <animate attributeName="cy" values="190;180;190" dur="2.8s" repeatCount="indefinite" />
                <animate attributeName="r" values="5;7;5" dur="1.5s" repeatCount="indefinite" />
              </circle>

              {/* Lightning bolt for live deals */}
              <g transform="translate(200, 150)">
                <path
                  d="M7 2v6h3l-4 8h3l4-8h-3V2H7z"
                  fill="#F59E0B"
                  opacity="0.8"
                />
                <animateTransform
