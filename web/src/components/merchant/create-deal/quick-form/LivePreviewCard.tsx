...
export const LivePreviewCard = ({
  ...
  return (
    <div
      className={cn(
        'rounded-2xl border border-border/80 bg-card p-5 shadow-[0_8px_22px_rgba(15,23,42,0.045)]',
        className,
      )}
    >
      ...
      <div className="mt-3 rounded-[1.3rem] bg-foreground p-5 text-background shadow-[0_12px_28px_rgba(15,23,42,0.18)]">
        ...
        {checkInRewardLabel ? (
          <div className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-card/12 dark:bg-card px-2.5 py-1 text-[11px] font-medium text-white">
