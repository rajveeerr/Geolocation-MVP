export const PATHS = {
  ...
  MERCHANT_DEALS_CREATE_STANDARD: '/merchant/deals/create/standard',
  MERCHANT_DEALS_CREATE_DAILY: '/merchant/deals/create/daily-deal',
  MERCHANT_DEALS_CREATE_REDEEM_NOW: '/merchant/deals/create/redeem-now',
  MERCHANT_DEALS_CREATE_BOUNTY: '/merchant/deals/create/bounty',
  MERCHANT_DEALS_CREATE_HIDDEN: '/merchant/deals/create/hidden',
  MERCHANT_HAPPY_HOUR_CREATE: '/merchant/deals/create/happy-hour/edit',
  ...
  MY_CHECKIN_REWARDS: '/my-activity/check-in-rewards',
