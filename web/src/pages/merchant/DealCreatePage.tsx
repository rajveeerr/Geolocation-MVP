...
const PendingApprovalMessage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-5rem)] bg-neutral-50">
            <div className="text-center p-8 max-w-lg mx-auto bg-white rounded-2xl border shadow-sm">
                ...
                <p className="mt-4 text-neutral-600">
                    ...
                    You will be able to create deals as soon as your profile is approved. We'll notify you via email.
                </p>
                <Button 
...
export const CreateDealPage = () => {
  ...
  if (error) {
    ...
    return (
        <div className="text-center py-20">
            <h2 className="text-xl text-red-600">Could not verify your merchant status.</h2>
            <p className="text-neutral-500">Please try again later or contact support.</p>
        </div>
    );
  }
  ...
  return (
    <div className="text-center py-20">
        <h2 className="text-xl font-bold text-neutral-800">Unable to Create Deal</h2>
        <p className="text-neutral-500 mt-2">Your merchant profile is not approved for deal creation.</p>
        <p className="text-neutral-500">Current status: <span className="font-semibold">{status || 'Not Found'}</span></p>
    </div>
  );
};
