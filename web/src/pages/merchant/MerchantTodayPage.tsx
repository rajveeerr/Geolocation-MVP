...
const EmptyStateIllustration = () => (
  <svg className="mx-auto h-24 w-24 text-neutral-300" viewBox="0 0 24 24" fill="none">
    <path 
    ...
    <div>
      {reservations.length === 0 ? (
        <div className="text-center py-16">
          ...
          <h2 className="mt-4 text-2xl font-bold text-neutral-800">You don't have any reservations</h2>
          <p className="mt-2 text-neutral-500">When a guest books a deal, their reservation will appear here.</p>
        </div>
      ) : (
